...
?>
    ...
    <head>
        ...
        <style>
            ...
            .gif-container {
                margin-top: 20px; /* Space between input and GIF */
            }

            .message-container {
                margin-top: 20px; /* Space between GIF and message */
            }
        </style>
    </head>
    <body>
...
if (!isset($_SESSION['authenticated'])) {
    ...
    if (isset($_POST['pass']) && password_verify($_POST['pass'], $stored_hashed_password)) {
        ...
        // Just show the login page without any message
        show_login_page();
    }
}
?>
