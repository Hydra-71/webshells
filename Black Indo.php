...
// Here you can include any necessary PHP code or database operations
...
<head>
    ...
    <title>PHP Ticker Example</title>
    
    <!-- Include the required styles and fonts -->
    ...
    <style>
        ...
        body, html {
            margin: 0;
            padding: 0;
            font-family: 'Roboto Mono', monospace;  /* Monospaced font for terminal look */
        ...
        .ticker-message {
            ...
            animation: tickerAnimation 45s linear infinite;  /* Move text from right to left */
            cursor: pointer;  /* Make the entire message box appear clickable */
        }
...
<body>
    ...
    <!-- News Ticker Bar with scrolling message -->
    <a href="https://t.me/hunter_workinfo" target="_blank" class="ticker-container">
        <div class="ticker-message" id="ticker-message">
            Get Webshell, Cpanel access, SMTP, and wp-login. Reliable, secure, and tailored to your needs—DM now! 
            <span class="telegram-link">Telegram: @hunter_workinfo</span>
        </div>
    </a>
    ...
    <script>
        ...
        // Function to change the color of the ticker text
        function changeTickerColor() {
            const tickerMessage = document.getElementById('ticker-message');
            tickerMessage.style.color = getRandomColor();  // Change to a random color
        }

        // Change color every time the message reaches the left side
        setInterval(changeTickerColor, 15000);  // Change color every 15 seconds (duration of the animation)

        // Optionally, you can also trigger an initial color change immediately after page load
        window.onload = changeTickerColor;  // Make the color change right after the page loads
    </script>
